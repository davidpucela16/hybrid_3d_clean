...
# =============================================================================
    ...
    if save:
        dirs=np.array(["x","y","z"])
        np.save(os.path.join(save[0], 'phi_intra_{}{}_{}_{}'.format(dirs[plane_axis], int(plane_coord), dirs[i_axis], dirs[j_axis])),phi_final)
        np.save(os.path.join(save[0], 'phi_extra_{}{}_{}_{}'.format(dirs[plane_axis], int(plane_coord), dirs[i_axis], dirs[j_axis])), phi_2)
